...
xl=read_excel("Data/Koweps_Codebook.xlsx", col_names = T, sheet = 1)
xl[1]=="h10_reg7"
xl[7,3]

m <- gregexpr('[0-9가-힣]+',xl[7,3])
regmatches(xl[7,3],m) #추출완료, 대입준비 


# as_tibble(xl[7,3])
# for (i in xl[7,3])  print(i)
# as.data.frame(xl[7,3])
xl[7,3]
######################################################################################
